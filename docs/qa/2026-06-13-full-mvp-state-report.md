...
- Update on 2026-06-15: `npm run smoke:production` now checks the deployed app health payload, gated Sentry example routes, app-route auth redirects, unauthenticated scheduler protection, unsigned Stripe webhook rejection, and browser security headers.
